...
module.exports = (db) => {
  router.post("/", (req, res) => {
    const sqlQuery = `SELECT guitars.id, guitars.name, guitars.price, guitars.type, guitars.img_url, guitars.description, guitars.seller_id, guitars.sold FROM guitars
